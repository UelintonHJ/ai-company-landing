    ...
    return (
        ...
        >
            ...
            <div className="relative rounded-2xl border border-zinc-800 bg-zinc-900/60 p-6 shadow-2xl shadow-blue-500/10">
                ...
                <div className="mb-6 flex flex-col items-center gap-2 lg:flex-row lg:justify-between">
                    <h2 className="text-lg font-semibold">
                        Operações com IA
                    </h2>

                    <span className="w-45 rounded-full bg-emerald-400/15 p-2 text-center text-sm font-semibold  text-emerald-300">
